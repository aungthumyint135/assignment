            ...
            <div class="card-body p-4">
                <div class="row dt-table-header">
                    <div class="col-lg-8 col-md-10 col-sm-12 me-auto d-flex">
                        ...
                        @can('CategoryCreate')
                            <a href="{{ route('admin.category.create') }}" class="btn btn-sm light btn-primary me-2 my-auto">
                ...
                <div class="table-responsive py-4">
                    <table id="categoryTb" class="table w-100 fw-normal align-middle" aria-describedby="heading">
                        <thead>
                        <tr>
